...
# = Class: nagios
#
# This class manages nagios service
#
#
# == Parameters
#
...
#
# [*dependency_class*]
#   Type: string, default: nagios::dependency
...
#
class nagios (
  $ensure            = $::nagios::params::ensure,
  $package           = $::nagios::params::package,
  $service           = $::nagios::params::service,
  $version           = $::nagios::params::version,
  $status            = $::nagios::params::status,
  $file_mode         = $::nagios::params::file_mode,
  $file_owner        = $::nagios::params::file_owner,
  $file_group        = $::nagios::params::file_group,
  $dependency_class  = $::nagios::params::dependency_class,
  $my_class          = $::nagios::params::my_class,
  $noops             = false,
